...
std::string sensorname_imuB = "imu3"; 		// Set imu tag name
const string serial_port_name_B = "/dev/rfcomm1"; // bluetooth  serial port
RazorAHRS *razor_B; 	//razor pointer Object
...
void on_data_B(const float data[])
{
...
int main(int argc, char *argv[])
{
  ...
  try
  {
    ...
    razor_B = new RazorAHRS(serial_port_name_B, on_data_B, on_error, RazorAHRS::ACC_MAG_GYR_CALIBRATED, sensorname_imuB, argv[1]);
  ...
  razor_B -> disable_continuous_streaming_output();
