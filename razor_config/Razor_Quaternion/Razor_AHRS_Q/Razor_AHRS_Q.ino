...
//////////////////////////////////////////////////////////////////
/// Below are the Serial Commands that can be used in the ////////
/// serial monitor. Some of these commands will be used for //////
/// calibration purposes discussed later. ////////////////////////
//////////////////////////////////////////////////////////////////
...
// SENSOR CALIBRATION
/*****************************************************************/
// It is recommended to use the link below for the magnetometer and gyro calibration. 
// Refer to provided paper for the accelerometer calibration.
...
//////////////////////////////////////////////////////////////////
/// Refer to page 7 of the provided document for further /////////
/// explanation. /////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////
...
#define GRAVITY 256.0f // "1G reference" used for Quaterinion/DCM filter and accelerometer calibration
...
// Quaternion timing in the main loop
...
//////////////////////////////////////////////////////////////////
/// The read_sensors() function calls for the outputs from the ///
/// gyro, accel, and magnetometer sensor. ////////////////////////
//////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////  
///////// Refer to Paper, Pages 4-6 for explanaiton of the //////// 
///////// reset_sensor_fusion() function below. //////////////////
//////////////////////////////////////////////////////////////////

// Read every sensor and record a time stamp
// Initialize DCM with unfiltered orientation
// Initialze quaternions with unfilitered orientation
...
//////////////////////////////////////////////////////////////////  
///////// Refer to Paper, Pages 7-8 for explanaiton of the /////// 
///////// compensate_sensor_errors() function below. /////////////
//////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////
/// The check_reset_calibration_session function is entered if ///
/// the calibration mode is turned on in the serial monitor. /////
/// This allows the callibration values to be set for the ////////
/// sensors. ///////////////////////////////////////////////////// 
//////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////
/// The section below was not altered or analized. I believe /////
/// it is to turn on the serial monitor and initialize all ///////
/// the sensor values. ///////////////////////////////////////////
//////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////
/// Below the main loop is entered and is where all the //////////
/// operations occur. ////////////////////////////////////////////
/////////////////////////////////////////////////////////////////
...
{
//////////////////////////////////////////////////////////////////
/// This section allows for different inputs to the serial ///////
/// monitor. These different commands are described at the ///////
/// top of this document starting on line 92 // ////////////////// 
//////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////
/// Below is for a bluetooth hookup to the IMU, which is not /////
...
//////////////////////////////////////////////////////////////////
/// Creates a timestamp for each sensor reading at a future //////
/// time. From this the time step Delta t is calculated and //////
/// is called "G_DT". ////////////////////////////////////////////
//////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////
/// Checks to see if in calibration mode /////////////////////////
//////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////
/// The sensors are calibrated every loop by function ////////////
/// below. Once again, this function is described on pages 7-8 ///
...
//////////////////////////////////////////////////////////////////
/// Below is where the Quaternion algorithms are called for //////
/// the attitude estimation of the IMU. Refer to pages 8-9 of ////
/// the provided document for further explanation. /////////////// 
//////////////////////////////////////////////////////////////////
    
      // Run quaternion algorithm
...
//////////////////////////////////////////////////////////////////
/// Outputs the desired values to the serial monitor. ////////////
